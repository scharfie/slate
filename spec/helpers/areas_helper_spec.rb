...
describe AreasHelper do
  ...
  it "should return proper panel title for each version" do
    panel_title(version(1)).should == 'Published'
    panel_title(version(2)).should == 'One version ago'
    panel_title(version(3)).should == 'Two versions ago'
    panel_title(version(4)).should == 'Three versions ago'
  end
  ...
  it "should return timestamp (this year) for area" do
    ...
    version_timestamp(@area).should == '9:00 am on September 7th'
  end
  ...
  it "should return timestamp (different year) for area" do
    ...
    version_timestamp(@area).should == 'September 7th 2008'
  end  
end
